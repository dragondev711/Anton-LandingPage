...
const Partners = () => {
  return (
    <div className="relative partner-panel-color rounded-lg flex flex-row flex-wrap content-baseline lg:justify-start justify-center w-[90%] p-[20px] md:p-[50px] gap-[20px] sm:gap-[40px] md:gap-[50px]">
      <div
